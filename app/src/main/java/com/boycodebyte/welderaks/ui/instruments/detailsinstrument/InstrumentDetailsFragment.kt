...
class InstrumentDetailsFragment: Fragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        instrumentDetailsViewModel=ViewModelProvider(this).get(InstrumentDetailsViewModel::class.java)
    }
    ...
    override fun onCreateView(
        ...
        binding.upDate.setOnClickListener {
            instrumentDetailsViewModel.saveChange(binding.spinner.selectedItemPosition,binding.instrumentDetails.text.toString())
